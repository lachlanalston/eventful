...
`)}function te(e){const t={Critical:0,Error:0,Warning:0,Info:0,Verbose:0};for(const n of e)t[n.severity]=(t[n.severity]||0)+1;return{total:e.length,...t}}function Ue(){return{total:0,Critical:0,Error:0,Warning:0,Info:0,Verbose:0}}function Be(e,t){let n=100;const a=te(e);n-=Math.min(a.Critical*15,40),n-=Math.min(a.Error*3,25),n-=Math.min(a.Warning*.5,10),n-=t.length*12;for(const s of t)s.report.confidence==="high"?n-=8:s.report.confidence==="medium"&&(n-=4);return Math.max(0,Math.min(100,Math.round(n)))}function qe(e){const t=new Set;return e.filter(n=>{const a=`${n.anchor.id}-${Math.floor(n.anchor.timestamp/1e3)}`;return t.has(a)?!1:(t.add(a),!0)})}function ne(e){return e.toLocaleTimeString([],{hour:"2-digit",minute:"2-digit",second:"2-digit"})}ge();document.querySelectorAll(".theme-btn").forEach(e=>e.addEventListener("click",we));const N=document.getElementById("upload-section"),se=document.getElementById("processing-section"),ie=document.getElementById("results-section"),w=document.getElementById("drop-zone"),T=document.getElementById("file-input"),K=document.getElementById("processing-text"),F=document.getElementById("overview-grid"),I=document.getElementById("incidents-section"),b=document.getElementById("event-table-wrap"),X=document.getElementById("event-log-filters-wrap"),R=document.getElementById("new-analysis-btn"),z=document.getElementById("results-sub");let k=[];T==null||T.addEventListener("change",e=>{var n;const t=(n=e.target.files)==null?void 0:n[0];t&&oe(t)});w==null||w.addEventListener("dragover",e=>{e.preventDefault(),w.classList.add("drag-over")});w==null||w.addEventListener("dragleave",()=>w.classList.remove("drag-over"));w==null||w.addEventListener("drop",e=>{var n;e.preventDefault(),w.classList.remove("drag-over");const t=(n=e.dataTransfer.files)==null?void 0:n[0];t&&oe(t)});R==null||R.addEventListener("click",_e);var J;(J=document.getElementById("lp-backdrop"))==null||J.addEventListener("click",P);var Z;(Z=document.getElementById("lp-close"))==null||Z.addEventListener("click",P);document.addEventListener("keydown",e=>{e.key==="Escape"&&P()});async function oe(e){if(!e.name.toLowerCase().endsWith(".xml")&&e.type!=="text/xml"&&e.type!=="application/xml"){Q("Please upload an XML file exported from Windows Event Viewer.");return}x(`Reading ${e.name}…`);try{const t=await e.text();x("Parsing events…"),await L();const n=Se(t);x(`Analysing ${n.length.toLocaleString()} events…`),await L();const a=Me(n);k=n,x("Building report…"),await L(),je(a,e.name)}catch(t){Q(t.message||"Failed to parse file."),A(N)}}function L(){return new Promise(e=>setTimeout(e,16))}function A(e){[N,se,ie].forEach(t=>{t&&(t.hidden=!0)}),e&&(e.hidden=!1)}function x(e){K&&(K.textContent=e),A(se)}function _e(){k=[],T&&(T.value=""),A(N)}function je(e,t){const{incidents:n,healthScore:a,computerName:s,stats:i}=e;if(z){const o=[];s&&o.push(s),o.push(`${i.total.toLocaleString()} events`),n.length&&o.push(`${n.length} incident${n.length!==1?"s":""} detected`),z.textContent=o.join(" · ")}He(a,i),Ve(n),ze(k),A(ie)}function He(e,t){if(!F)return;const n=e>=80?"#34d399":e>=60?"#f59e0b":"#f43f5e",a=e>=80?"Good":e>=60?"Degraded":"Critical";F.innerHTML=`
      ...
      <div class="incident-body">
        ...
        <div class="incident-section">
          ...
          <div class="evidence-list">
            ${s.slice(0,6).map(({event:m,score:f})=>`
  ...
  `;const o=(l,u,g)=>{var h;return(h=document.getElementById(l))==null?void 0:h.addEventListener(u,g)};o("tbl-query","input",l=>{d.query=l.target.value,d.page=0,S()}),o("tbl-severity","change",l=>{d.severity=l.target.value,d.page=0,S()}),o("tbl-provider","change",l=>{d.provider=l.target.value,d.page=0,S()}),o("tbl-channel","change",l=>{d.channel=l.target.value,d.page=0,S()}),o("tbl-from","change",l=>{d.fromTime=l.target.value,d.page=0,S()}),o("tbl-to","change",l=>{d.toTime=l.target.value,d.page=0,S()}),o("tbl-noise","click",l=>{d.hideNoisy=!d.hideNoisy,d.page=0,l.target.classList.toggle("active",d.hideNoisy),l.target.textContent=d.hideNoisy?"Show noise":"Hide noise",S()}),o("tbl-csv","click",()=>Qe(ae())),S()}function ae(){const e=d.query.toLowerCase(),t=d.fromTime?new Date(d.fromTime).getTime():null,n=d.toTime?new Date(d.toTime).getTime():null;let a=k.filter(s=>!(d.severity&&s.severity!==d.severity||d.provider&&s.provider!==d.provider||d.channel&&s.channel!==d.channel||t!==null&&s.timestamp<t||n!==null&&s.timestamp>n||d.hideNoisy&&Xe.has(s.provider)||e&&!`${s.id} ${s.provider} ${s.channel} ${s.message} ${s.severity}`.toLowerCase().includes(e)));return a.sort((s,i)=>{let o=0;switch(d.sortCol){case"timestamp":o=s.timestamp-i.timestamp;break;case"severity":o=(Y[s.severity]??9)-(Y[i.severity]??9);break;case"id":o=s.id-i.id;break;case"provider":o=(s.provider||"").localeCompare(i.provider||"");break}return d.sortDir==="asc"?o:-o}),a}function S(){if(!b)return;const e=ae(),t=e.length,n=Math.max(0,Math.ceil(t/d.pageSize)-1);d.page=Math.min(d.page,n);const a=d.page*d.pageSize,s=e.slice(a,a+d.pageSize);if(!t){b.innerHTML='<div class="table-empty">No events match the current filters.</div>';return}const i=c=>`<span class="sort-arrow ${d.sortCol===c?"active":""}">${d.sortCol===c?d.sortDir==="asc"?"↑":"↓":"↕"}</span>`,o=c=>d.sortCol===c?"sort-active":"";b.innerHTML=`
  ...
  `,b.querySelectorAll("th[data-sort]").forEach(c=>{c.addEventListener("click",()=>{const l=c.dataset.sort;d.sortDir=d.sortCol===l&&d.sortDir==="asc"?"desc":"asc",d.sortCol=l,d.page=0,S()})});const r=(c,l)=>{var u;return(u=document.getElementById(c))==null?void 0:u.addEventListener("click",l)};r("pg-first",()=>{d.page=0,S()}),r("pg-prev",()=>{d.page--,S()}),r("pg-next",()=>{d.page++,S()}),r("pg-last",()=>{d.page=n,S()}),b.querySelectorAll("tbody tr[data-record]").forEach(c=>{c.addEventListener("click",l=>{if(l.target.closest(".table-event-id"))return;const u=parseInt(c.dataset.record,10);d.expandedIds.has(u)?d.expandedIds.delete(u):d.expandedIds.add(u),S()})}),b.querySelectorAll(".table-event-id").forEach(c=>{c.addEventListener("click",l=>{l.stopPropagation(),re(c.dataset.lookupId)})}),b.querySelectorAll(".ev-advanced-toggle").forEach(c=>{c.addEventListener("click",l=>{l.stopPropagation();const g=c.closest(".ev-detail-inner").querySelector(".ev-advanced-section").classList.toggle("ev-advanced-open");c.textContent=g?"Advanced ▲":"Advanced ▼"})})}function Ye(e){var m;const t=d.expandedIds.has(e.recordId),n=e.severity.toLowerCase(),a=Object.keys(e.data||{}),s=e.message?p(e.message.substring(0,150))+(e.message.length>150?"…":""):'<span style="color:var(--text3);font-style:italic">no message</span>',i=`
...
`),i=URL.createObjectURL(new Blob([s],{type:"text/csv;charset=utf-8;"})),o=Object.assign(document.createElement("a"),{href:i,download:`eventful-${new Date().toISOString().slice(0,10)}.csv`});document.body.appendChild(o),o.click(),document.body.removeChild(o),URL.revokeObjectURL(i)}function re(e){const t=parseInt(e,10),n=document.getElementById("lookup-panel"),a=document.getElementById("lp-body");if(!n||!a)return;const s=ye.find(o=>o.id===t),i=k.filter(o=>o.id===t);a.innerHTML=Je(t,s,i),n.hidden=!1,a.querySelectorAll(".lp-copy-ps").forEach(o=>{o.addEventListener("click",()=>{navigator.clipboard.writeText(o.dataset.code).then(()=>{o.textContent="Copied!",setTimeout(()=>{o.textContent="Copy"},2e3)})})}),a.querySelectorAll(".lp-advanced-toggle").forEach(o=>{o.addEventListener("click",()=>{const c=o.nextElementSibling.classList.toggle("lp-advanced-open");o.textContent=c?"Advanced ▲":"Advanced ▼"})})}function P(){const e=document.getElementById("lookup-panel");e&&(e.hidden=!0)}function Je(e,t,n){var i,o,r;let a="";if(t){const c=((i=t.severity)==null?void 0:i.toLowerCase())??"info";a+=`
    ...
    <div class="lp-section">
      ...
      ${s.map((c,l)=>{var v;const u=c.taskName||c.opcode||null,g=c.opcodeName||c.opcode||null,h=(v=c.keywordNames)!=null&&v.length?c.keywordNames.join(", "):c.keywords||null,m=c.dataAnon||[],f=[["Raw Level",String(c.levelNum)],["Raw Task",c.task],["Raw Opcode",c.opcode],["Raw Keywords",c.keywords],["Version",c.version],["Qualifiers",c.qualifiers],["Provider Desc.",c.providerDescription],["Related Act. ID",c.relatedActivityId]].filter(([,$])=>$);return`
        ...
        ${Object.keys(c.data||{}).length||m.length?`
