...
`)}function Y(e){const t={Critical:0,Error:0,Warning:0,Info:0,Verbose:0};for(const n of e)t[n.severity]=(t[n.severity]||0)+1;return{total:e.length,...t}}function ke(){return{total:0,Critical:0,Error:0,Warning:0,Info:0,Verbose:0}}function Ee(e,t){let n=100;const o=Y(e);n-=Math.min(o.Critical*15,40),n-=Math.min(o.Error*3,25),n-=Math.min(o.Warning*.5,10),n-=t.length*12;for(const s of t)s.report.confidence==="high"?n-=8:s.report.confidence==="medium"&&(n-=4);return Math.max(0,Math.min(100,Math.round(n)))}function Ce(e){const t=new Set;return e.filter(n=>{const o=`${n.anchor.id}-${Math.floor(n.anchor.timestamp/1e3)}`;return t.has(o)?!1:(t.add(o),!0)})}re();const N=document.getElementById("upload-section"),X=document.getElementById("processing-section"),Q=document.getElementById("results-section"),w=document.getElementById("drop-zone"),M=document.getElementById("file-input"),H=document.getElementById("processing-text"),_=document.getElementById("overview-grid"),$=document.getElementById("incidents-section"),E=document.getElementById("event-table-wrap"),C=document.getElementById("event-log-filters-wrap"),U=document.getElementById("new-analysis-btn"),V=document.getElementById("results-sub");let k=[],x=new Map;M==null||M.addEventListener("change",e=>{var n;const t=(n=e.target.files)==null?void 0:n[0];t&&J(t)});w==null||w.addEventListener("dragover",e=>{e.preventDefault(),w.classList.add("drag-over")});w==null||w.addEventListener("dragleave",()=>w.classList.remove("drag-over"));w==null||w.addEventListener("drop",e=>{var n;e.preventDefault(),w.classList.remove("drag-over");const t=(n=e.dataTransfer.files)==null?void 0:n[0];t&&J(t)});U==null||U.addEventListener("click",Ie);var z;(z=document.getElementById("lp-backdrop"))==null||z.addEventListener("click",B);var K;(K=document.getElementById("lp-close"))==null||K.addEventListener("click",B);document.addEventListener("keydown",e=>{e.key==="Escape"&&B()});async function J(e){const t=e.name.toLowerCase();if(t.endsWith(".zip")){R('This looks like a ZIP archive — use <a href="incident-analyzer.html">Windows Incident Analyser</a> to analyse multiple logs together.');return}if(!t.endsWith(".xml")&&e.type!=="text/xml"&&e.type!=="application/xml"){R("Please upload an XML file exported from Windows Event Viewer.");return}A(`Reading ${e.name}…`);try{const n=await e.text();if(n.includes("<RelMonReport")){R('This looks like a Reliability Monitor export — use <a href="reliability-analyzer.html">Reliability Analyser</a> instead.');return}A("Parsing events…"),await q();const o=ce(n);A(`Analysing ${o.length.toLocaleString()} events…`),await q();const s=me(o);k=o,x=new Map;for(const i of o)x.set(i.id,(x.get(i.id)||0)+1);A("Building report…"),await q(),xe(s,e.name)}catch(n){R(n.message||"Failed to parse file."),T(N)}}function q(){return new Promise(e=>setTimeout(e,16))}function T(e){[N,X,Q].forEach(t=>{t&&(t.hidden=!0)}),e&&(e.hidden=!1)}function A(e){H&&(H.textContent=e),T(X)}function Ie(){k=[],x=new Map,M&&(M.value=""),T(N)}function xe(e,t){const{incidents:n,healthScore:o,computerName:s,stats:i}=e,a=document.querySelector(".results-title");if(a&&(a.textContent=t.replace(/\.xml$/i,"")),V){const p=[];s&&p.push(s),p.push(`${i.total.toLocaleString()} events`),n.length&&p.push(`${n.length} incident${n.length!==1?"s":""} detected`),V.textContent=p.join(" · ")}De(o,i),Me(n),Re(k);const r=document.getElementById("tab-inc-count"),l=document.getElementById("tab-evt-count");r&&(r.textContent=n.length),l&&(l.textContent=i.total.toLocaleString()),document.querySelectorAll(".analyzer-tab").forEach(p=>{p.addEventListener("click",()=>{document.querySelectorAll(".analyzer-tab").forEach(f=>f.classList.remove("active")),p.classList.add("active");const h=p.dataset.tab;document.getElementById("incidents-section").hidden=h!=="incidents",document.getElementById("events-panel").hidden=h!=="events"})}),T(Q)}function De(e,t){if(!_)return;const n=e>=80?"#34d399":e>=60?"#f59e0b":"#f43f5e",o=e>=80?"Good":e>=60?"Degraded":"Critical";_.innerHTML=`
  ...
  `}function Me(e){if($){if(!e.length){$.innerHTML=`
    ...
    `;return}$.innerHTML=e.map((t,n)=>Te(t)).join(""),$.querySelectorAll(".incident-toggle").forEach(t=>{t.addEventListener("click",n=>{if(n.target.closest("[data-lookup-id]"))return;const s=t.closest(".incident-card").querySelector(".incident-body"),i=t.querySelector(".incident-chevron"),a=!s.hidden;s.hidden=a,i.classList.toggle("open",!a)})}),$.querySelectorAll(".copy-summary-btn").forEach(t=>{t.addEventListener("click",()=>{const n=t.dataset.summary;navigator.clipboard.writeText(n).then(()=>{t.textContent="Copied!",t.classList.add("copied"),setTimeout(()=>{t.textContent="Copy for ticket",t.classList.remove("copied")},2e3)})})}),$.querySelectorAll(".evidence-item").forEach(t=>{t.addEventListener("click",n=>{if(n.stopPropagation(),n.target.closest("[data-lookup-id]"))return;const s=t.closest(".evidence-wrap").querySelector(".evidence-detail"),i=t.querySelector(".ev-expand-chevron"),a=!s.hidden;s.hidden=a,t.classList.toggle("expanded",!a),i&&(i.textContent=a?"▶":"▼")})}),$.querySelectorAll(".timeline-item").forEach(t=>{t.addEventListener("click",n=>{if(n.stopPropagation(),n.target.closest("[data-lookup-id]"))return;const o=t.closest(".timeline-item-wrap");if(!o)return;const s=o.querySelector(".timeline-detail");if(!s)return;const i=t.querySelector(".tl-expand-chevron"),a=!s.hidden;s.hidden=a,i&&(i.textContent=a?"▶":"▼")})}),$.querySelectorAll(".ev-advanced-toggle").forEach(t=>{t.addEventListener("click",n=>{n.stopPropagation();const s=t.closest(".ev-inline-detail").querySelector(".ev-advanced-section").classList.toggle("ev-advanced-open");t.textContent=s?"Advanced ▲":"Advanced ▼"})}),$.querySelectorAll(".ev-copy-btn").forEach(t=>{t.addEventListener("click",n=>{var o;n.stopPropagation(),(o=navigator.clipboard)==null||o.writeText(t.dataset.copy).then(()=>{t.classList.add("copied"),setTimeout(()=>t.classList.remove("copied"),2e3)})})}),$.querySelectorAll("[data-lookup-id]").forEach(t=>{t.addEventListener("click",n=>{n.stopPropagation(),te(t.dataset.lookupId)})})}}function Te(e,t){var f,g;const{anchor:n,windowEvents:o,topContributors:s,signatureResult:i,report:a}=e,r=(f=i[0])==null?void 0:f.signature,l=a.confidence,p=He(n.severity),h=l==="high"?"conf-high":l==="medium"?"conf-medium":"conf-low";return`
    <div class="incident-card">
        ...
        <div class="incident-header-left">
          ...
          <div>
            ...
            <div class="incident-meta">
              ...
              ${a.confidenceReason?`<span class="conf-reason">${v(a.confidenceReason)}</span>`:""}
            </div>
          </div>
        </div>
      ...
      <div class="incident-body" hidden>
        ...
        <div class="incident-section">
          ...
          <p class="incident-text">${v(a.what)}</p>
        </div>

        <!-- Root cause -->
        <div class="incident-section">
          <div class="incident-section-label">Likely root cause</div>
          <p class="incident-text">${v(a.rootCause)}</p>
        </div>
            ...
            ${s.slice(0,6).map(({event:u,score:I})=>`
              <div class="evidence-wrap">
                <div class="evidence-item">
                  ...
                  <span class="ev-provider">${v(O(u.provider))}</span>
                  <span class="ev-time">${P(u.timestamp)}</span>
        ...
        <div class="incident-section">
          ...
          <ol class="next-steps-list">
            ${a.nextSteps.map(u=>`<li>${v(u)}</li>`).join("")}
          </ol>
        </div>
        `:""}
        ...
        <div class="incident-section">
          <div class="technician-hint">
            ...
            <span class="hint-text">${v(a.technicianHint)}</span>
          </div>
        </div>
        `:""}
        ...
        <div class="incident-footer">
          <button class="copy-summary-btn" data-summary="${v(a.psaSummary)}">
            Copy for ticket
          </button>
          ${(g=a.alternateSignatures)!=null&&g.length?`
          <span class="alt-signatures">
            Also possible: ${a.alternateSignatures.map(u=>u.signature.name).join(", ")}
          </span>
          `:""}
        </div>
      </div>
    </div>
  `}function Le(e,t){const n=[...e,t].sort((i,a)=>i.timestamp-a.timestamp),s=n.length>12?[...n.slice(0,6),{_ellipsis:!0,count:n.length-10},...n.slice(-4)]:n;return`
    <div class="incident-section">
            ...
            <div class="timeline-item-wrap">
              <div class="timeline-item ${a?"timeline-anchor":""}">
                ...
                <div class="tl-content">
                  ...
                  <span class="tl-provider">${v(O(i.provider))}</span>
          ...
          <div class="provider-option-list">
            ${t.map(d=>`
              <label class="provider-option">
                ...
                <span class="provider-option-name" title="${v(d)}">${v(O(d))}</span>
              </label>`).join("")}
          </div>
        </div>
      </div>
  ...
  `;const a=(d,m,b)=>{var S;return(S=document.getElementById(d))==null?void 0:S.addEventListener(m,b)};a("tbl-query","input",d=>{c.query=d.target.value,c.page=0,y()}),C.querySelectorAll(".tbl-sev-cb").forEach(d=>{d.addEventListener("change",()=>{d.checked?c.severities.add(d.value):c.severities.delete(d.value),d.closest(".sev-chip").classList.toggle("active",d.checked),c.page=0,u(),y()})});const r=document.getElementById("tbl-provider-btn"),l=document.getElementById("tbl-provider-panel"),p=document.getElementById("tbl-provider-label"),h=document.getElementById("tbl-provider-clear"),f=document.getElementById("tbl-provider-select-all");r==null||r.addEventListener("click",d=>{d.stopPropagation();const m=l.hidden;l.hidden=!m,r.classList.toggle("open",m)});function g(){const d=c.providers.size;p.textContent=d===0?"All providers":`${d} provider${d!==1?"s":""}`,r==null||r.classList.toggle("filtered",d>0)}function u(){const d=c.fromTime?new Date(c.fromTime).getTime():null,m=c.toTime?new Date(c.toTime).getTime():null,b=new Set(k.filter(S=>!(c.severities.size>0&&!c.severities.has(S.severity)||c.channel&&S.channel!==c.channel||d!==null&&S.timestamp<d||m!==null&&S.timestamp>m||c.hideNoisy&&Z.has(S.provider))).map(S=>S.provider).filter(Boolean));C.querySelectorAll(".provider-option").forEach(S=>{const D=S.querySelector(".provider-cb"),W=b.has(D.value);S.classList.toggle("provider-option-unavailable",!W),D.disabled=!W,!W&&D.checked&&(D.checked=!1,c.providers.delete(D.value))}),g()}C.querySelectorAll(".provider-cb").forEach(d=>{d.addEventListener("change",()=>{d.checked?c.providers.add(d.value):c.providers.delete(d.value),g(),c.page=0,y()})}),h==null||h.addEventListener("click",d=>{d.stopPropagation(),c.providers.clear(),C.querySelectorAll(".provider-cb").forEach(m=>m.checked=!1),g(),c.page=0,y()}),f==null||f.addEventListener("click",d=>{d.stopPropagation(),C.querySelectorAll(".provider-option:not([hidden]) .provider-cb").forEach(m=>{m.checked=!0,c.providers.add(m.value)}),g(),c.page=0,y()}),a("tbl-provider-search","input",d=>{const m=d.target.value.toLowerCase();C.querySelectorAll(".provider-option").forEach(b=>{b.hidden=m?!b.querySelector(".provider-option-name").textContent.toLowerCase().includes(m):!1})}),a("tbl-channel","change",d=>{c.channel=d.target.value,c.page=0,u(),y()}),a("tbl-from","change",d=>{c.fromTime=d.target.value,c.page=0,u(),y()}),a("tbl-to","change",d=>{c.toTime=d.target.value,c.page=0,u(),y()}),a("tbl-noise","click",d=>{c.hideNoisy=!c.hideNoisy,c.page=0,d.target.classList.toggle("active",c.hideNoisy),d.target.textContent=c.hideNoisy?"Show noise":"Hide noise",u(),y()}),a("tbl-csv","click",()=>Ne(ee())),u(),y()}function ee(){const e=c.query.toLowerCase(),t=c.fromTime?new Date(c.fromTime).getTime():null,n=c.toTime?new Date(c.toTime).getTime():null;let o=k.filter(s=>{if(c.severities.size>0&&!c.severities.has(s.severity)||c.providers.size>0&&!c.providers.has(s.provider)||c.channel&&s.channel!==c.channel||t!==null&&s.timestamp<t||n!==null&&s.timestamp>n||c.hideNoisy&&Z.has(s.provider))return!1;if(e){const i=/^\d+$/.test(e)?parseInt(e,10):null;if(i!==null){if(s.id!==i)return!1}else if(!`${s.id} ${s.provider} ${s.channel} ${s.message} ${s.severity}`.toLowerCase().includes(e))return!1}return!0});return o.sort((s,i)=>{let a=0;switch(c.sortCol){case"timestamp":a=s.timestamp-i.timestamp;break;case"severity":a=(G[s.severity]??9)-(G[i.severity]??9);break;case"id":a=s.id-i.id;break;case"provider":a=(s.provider||"").localeCompare(i.provider||"");break}return c.sortDir==="asc"?a:-a}),o}function y(){if(!E)return;const e=ee(),t=e.length,n=Math.max(0,Math.ceil(t/c.pageSize)-1);c.page=Math.min(c.page,n);const o=c.page*c.pageSize,s=e.slice(o,o+c.pageSize);if(!t){E.innerHTML='<div class="table-empty">No events match the current filters.</div>';return}const i=l=>`<span class="sort-arrow ${c.sortCol===l?"active":""}">${c.sortCol===l?c.sortDir==="asc"?"↑":"↓":"↕"}</span>`,a=l=>c.sortCol===l?"sort-active":"";E.innerHTML=`
    <div class="table-info-bar">
      <span class="table-count-text">
        ${(o+1).toLocaleString()}–${Math.min(o+c.pageSize,t).toLocaleString()} of ${t.toLocaleString()} event${t!==1?"s":""}
  ...
  `,E.querySelectorAll("th[data-sort]").forEach(l=>{l.addEventListener("click",()=>{const p=l.dataset.sort;c.sortDir=c.sortCol===p&&c.sortDir==="asc"?"desc":"asc",c.sortCol=p,c.page=0,y()})});const r=(l,p)=>{var h;return(h=document.getElementById(l))==null?void 0:h.addEventListener("click",p)};r("pg-first",()=>{c.page=0,y()}),r("pg-prev",()=>{c.page--,y()}),r("pg-next",()=>{c.page++,y()}),r("pg-last",()=>{c.page=n,y()}),E.querySelectorAll("tbody tr[data-record]").forEach(l=>{l.addEventListener("click",p=>{if(p.target.closest(".table-event-id"))return;const h=parseInt(l.dataset.record,10);c.expandedIds.has(h)?c.expandedIds.delete(h):c.expandedIds.add(h),y()})}),E.querySelectorAll(".table-event-id").forEach(l=>{l.addEventListener("click",p=>{p.stopPropagation(),te(l.dataset.lookupId)})}),E.querySelectorAll(".ev-advanced-toggle").forEach(l=>{l.addEventListener("click",p=>{p.stopPropagation();const f=l.closest(".ev-detail-inner").querySelector(".ev-advanced-section").classList.toggle("ev-advanced-open");l.textContent=f?"Advanced ▲":"Advanced ▼"})}),E.querySelectorAll(".ev-copy-btn").forEach(l=>{l.addEventListener("click",p=>{var h;p.stopPropagation(),(h=navigator.clipboard)==null||h.writeText(l.dataset.copy).then(()=>{l.classList.add("copied"),setTimeout(()=>l.classList.remove("copied"),2e3)})})})}function Pe(e){const t=c.expandedIds.has(e.recordId),n=e.severity.toLowerCase(),o=Object.keys(e.data||{}),s=e.message?v(e.message.substring(0,150))+(e.message.length>150?"…":""):'<span style="color:var(--text3);font-style:italic">no message</span>',i=`
    <tr class="ev-row-${n}${t?" row-expanded":""}" data-record="${e.recordId}">
      ...
      <td class="ev-col-provider" title="${v(e.provider)}">${v(O(e.provider))}</td>
      <td class="ev-col-channel">${v(e.channel)}</td>
      <td class="ev-col-message">${s}</td>
    </tr>`;if(!t)return i;const a=e.taskName||e.task||null,r=oe(e.opcode,e.opcodeName),l=ae(e.keywords,e.keywordNames),p=se(e.userSID),h=x.get(e.id)||1,f=k.filter(m=>m.recordId!==e.recordId&&Math.abs(m.timestamp-e.timestamp)<=3e4).length,g=[["Time (local)",e.timestamp.toLocaleString()],["Time (UTC)",e.timestamp.toISOString()],["Provider",e.provider],["Channel",e.channel],["Computer",e.computer],["Record ID",e.recordId||null],["User SID",p],["Process ID",e.processId||null],["Thread ID",e.threadId||null],["Activity ID",e.activityId],["Related Act. ID",e.relatedActivityId],["Task",a],["Opcode",r],["Keywords",l]].filter(([,m])=>m),u=[["Raw Level",String(e.levelNum)],["Raw Task",e.task],["Raw Opcode",e.opcode],["Raw Keywords",e.keywords],["Version",e.version],["Qualifiers",e.qualifiers],["Provider Desc.",e.providerDescription]].filter(([,m])=>m),I=ie(e.message),L=I?`<div class="ev-detail-message-wrap">
    ...
    </tr>`}function Ne(e){const t=["Time (UTC)","Severity","EventID","Provider","Channel","Computer","RecordID","ProcessID","ThreadID","UserSID","ActivityID","RelatedActivityID","Task","TaskName","Opcode","OpcodeName","Keywords","KeywordNames","Version","Qualifiers","ProviderDescription","Message","EventData","EventDataAnon"],n=r=>`"${String(r??"").replace(/"/g,'""').replace(/\r?\n/g," ")}"`,o=e.map(r=>[r.timestamp.toISOString(),r.severity,r.id,n(r.provider),n(r.channel),n(r.computer),r.recordId,r.processId||"",r.threadId||"",n(r.userSID),n(r.activityId),n(r.relatedActivityId),n(r.task),n(r.taskName),n(r.opcode),n(r.opcodeName),n(r.keywords),n((r.keywordNames||[]).join("; ")),n(r.version),n(r.qualifiers),n(r.providerDescription),n(r.message),n(Object.entries(r.data||{}).map(([l,p])=>`${l}=${p}`).join("; ")),n((r.dataAnon||[]).join("; "))].join(",")),s=[t.join(","),...o].join(`\r
`),i=URL.createObjectURL(new Blob([s],{type:"text/csv;charset=utf-8;"})),a=Object.assign(document.createElement("a"),{href:i,download:`eventful-${new Date().toISOString().slice(0,10)}.csv`});document.body.appendChild(a),a.click(),document.body.removeChild(a),URL.revokeObjectURL(i)}function te(e){const t=parseInt(e,10),n=document.getElementById("lookup-panel"),o=document.getElementById("lp-body");if(!n||!o)return;const s=de.find(a=>a.id===t),i=k.filter(a=>a.id===t);o.innerHTML=Be(t,s,i),n.hidden=!1,o.querySelectorAll(".lp-copy-ps").forEach(a=>{a.addEventListener("click",()=>{navigator.clipboard.writeText(a.dataset.code).then(()=>{a.textContent="Copied!",setTimeout(()=>{a.textContent="Copy"},2e3)})})}),o.querySelectorAll(".lp-show-in-log").forEach(a=>{a.addEventListener("click",()=>{const r=a.dataset.filterId;B(),document.querySelectorAll(".analyzer-tab").forEach(h=>h.classList.remove("active"));const l=document.querySelector('.analyzer-tab[data-tab="events"]');l&&l.classList.add("active"),document.getElementById("incidents-section").hidden=!0,document.getElementById("events-panel").hidden=!1,c.query=r,c.page=0;const p=document.getElementById("tbl-query");p&&(p.value=r),y()})})}function B(){const e=document.getElementById("lookup-panel");e&&(e.hidden=!0)}function Be(e,t,n){var s,i,a;const o=n.length?`<button class="lp-show-in-log" data-filter-id="${e}">Show all ${n.length} occurrence${n.length!==1?"s":""} in All Events →</button>`:"";if(t){const r=((s=t.severity)==null?void 0:s.toLowerCase())??"info";return`
    ...
    <div class="lp-section">
      ...
      ${o}
    </div>`}function ne(e){const t=e.taskName||e.task||null,n=oe(e.opcode,e.opcodeName),o=ae(e.keywords,e.keywordNames),s=se(e.userSID),i=e.dataAnon||[],a=Object.keys(e.data||{}),r=x.get(e.id)||1,l=k.filter(g=>g.recordId!==e.recordId&&Math.abs(g.timestamp-e.timestamp)<=3e4).length,p=ie(e.message),h=[["Time (local)",e.timestamp.toLocaleString()],["Time (UTC)",e.timestamp.toISOString()],["Provider",e.provider],["Channel",e.channel],["Computer",e.computer],["Record ID",e.recordId||null],["User SID",s],["Process ID",e.processId||null],["Thread ID",e.threadId||null],["Activity ID",e.activityId],["Task",t],["Opcode",n],["Keywords",o]].filter(([,g])=>g),f=[["Raw Level",String(e.levelNum)],["Raw Task",e.task],["Raw Opcode",e.opcode],["Raw Keywords",e.keywords],["Version",e.version]].filter(([,g])=>g);return`
